...
{
    SUBCASE("Additive Operation Vector2+Int")
    {
    ...
    SUBCASE("Additive Operation Vector2+Float")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase + 10.5f;
        CHECK(vNew.X == ggp::fix16{11.5f});
        CHECK(vNew.Y == ggp::fix16{12.5f});
    }
    SUBCASE("Additive Operation Vector2+=Float")
    {
        ggp::Vec2 v = ggp::Vec2(1, 4);
        v += 11.3f;
        CHECK(v.X == ggp::fix16{12.3f});
        CHECK(v.Y == ggp::fix16{15.3f});
    }
    SUBCASE("Additive Operation Vector2+fix16")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
    ...
    SUBCASE("Additive Operation Vector2+Vector2")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
...
{
    SUBCASE("Subtractive Operation Vector2-Int")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase - 10;
        CHECK(vNew.X == ggp::fix16{-9});
    ...
    SUBCASE("Subtractive Operation Vector2-Float")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase - 10.6f;
        CHECK(vNew.X == ggp::fix16{-9.6f});
        CHECK(vNew.Y == ggp::fix16{-8.6f});
    }
    SUBCASE("Subtractive Operation Vector2-=Float")
    {
        ggp::Vec2 v = ggp::Vec2(1, 4);
        v -= 11.2f;
        CHECK(v.X == ggp::fix16{-10.2f});
        CHECK(v.Y == ggp::fix16{-7.2f});
    }
    SUBCASE("Subtractive Operation Vector2-fix16")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase - ggp::fix16{8};
    ...
    SUBCASE("Subtractive Operation Vector2-Vector2")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase - ggp::Vec2(6.5f, 7.2f);
...
{
    SUBCASE("Multiplication Operation Vector2*Int")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase * 10;
    ...
    SUBCASE("Multiplication Operation Vector2*Float")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase * 10.2f;
        CHECK(vNew.X == ggp::fix16{10.2f});
        CHECK(vNew.Y == ggp::fix16{20.4f});
    }
    SUBCASE("Multiplication Operation Vector2*=Float")
    {
        ggp::Vec2 v = ggp::Vec2(1, 4);
        v *= 11.5f;
        CHECK(v.X == ggp::fix16{11.5f});
        CHECK(v.Y == ggp::fix16{46.0f});
    }
    SUBCASE("Multiplication Operation Vector2*fix16")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase * ggp::fix16{8};
    ...
    SUBCASE("Multiplication Operation Vector2*Vector2")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
        ggp::Vec2 vNew = vBase * ggp::Vec2(6.5f, 7.2f);
...
{
    SUBCASE("Division Operation Vector2/Int")
    {
    ...
    SUBCASE("Division Operation Vector2/Float")
    {
        ggp::Vec2 vBase = ggp::Vec2(34, 204);
        ggp::Vec2 vNew = vBase / 2.5f;
        CHECK(vNew.X == ggp::fix16{13.6f});
        CHECK(vNew.Y == ggp::fix16{81.6f});
    }
    SUBCASE("Division Operation Vector2/=Float")
    {
        ggp::Vec2 v = ggp::Vec2(34, 204);
        v /= 2.5f;
        CHECK(v.X == ggp::fix16{13.6f});
        CHECK(v.Y == ggp::fix16{81.6f});
    }
    SUBCASE("Division Operation Vector2/fix16")
    {
        ggp::Vec2 vBase = ggp::Vec2(1, 2);
    ...
    SUBCASE("Division Operation Vector2/Vector2")
    {
